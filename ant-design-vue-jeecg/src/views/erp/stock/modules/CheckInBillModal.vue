      ...
      <a-form :form="form">
        ...
        <a-row>
          ...
          <a-col v-show="false" :span="8">
            <a-form-item label="源单id" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <a-input :readOnly="true" v-decorator="[ 'sourceId']" ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="8">
          ...
          <a-col :span="8">
            <a-form-item label="自动生成" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <j-dict-select-tag disabled type="list" v-decorator="['isAuto']" :trigger-change="true" dictCode="yn" />
            </a-form-item>
          </a-col>
          <a-col :span="16">
  ...
  export default {
    ...
    methods: {
      ...
      editAfter() {
        ...
        let fieldval = pick(this.model,'billNo','billDate','sourceType','sourceId','sourceNo','handlerId','isRubric',
          'attachment','remark','billProcStatus','approverId','flowId','isApproved','effectiveTime','isVoided','isClosed',
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'billNo','billDate','sourceType','sourceId','sourceNo','handlerId','isRubric',
          'attachment','remark','billProcStatus','approverId','flowId','isApproved','effectiveTime','isVoided','isClosed',
          'sysOrgCode','createBy','createTime','updateBy','updateTime'))
      },
