    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        ...
        <a-row>
          ...
          <a-col :span="8">
            <a-form-item label="调拨经办" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
    ...
    methods: {
      ...
      validateQty(type, value, row, column, callback, target) {
        ...
        if (totalQty > inventoryQty) {
          callback(false, '该库存批次的出库数量合计不能大于源库存数量！');
        } else {
          callback(true);
        }
      },
