    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        ...
        <a-row>
          ...
          <a-col :span="8">
            <a-form-item label="经办人" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <j-select-user-by-dep :disabled="readOnly" v-decorator="['handlerId', validatorRules.handlerId]" :trigger-change="true" dictCode="sys_user,realname,username"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
        ...
        stkIoBillEntryTable: {
          ...
          columns: [
            ...
            },
            {
              ...
              orgFields: "material_id,warehouse_id,batch_no,supplier_id,unit_id,qty,cost,id",
              destFields: "materialId,warehouseId,batchNo,supplierId,inventoryUnitId,inventoryQty,inventorCost,inventoryId",
              width:"45px",
            },
            {
              title: '供应商',
    ...
    methods: {
      ...
      editAfter() {
        ...
        let fieldval = pick(this.model, 'billNo', 'billDate', 'sourceType', 'sourceId', 'sourceNo', 'handlerId', 'isRubric', 'attachment', 'remark', 'billProcStatus', 'approverId', 'flowId', 'isApproved', 'effectiveTime', 'isVoided', 'isClosed', 'sysOrgCode', 'createBy', 'createTime', 'updateBy', 'updateTime')
      ...
      popupCallback(row) {
        this.form.setFieldsValue(pick(row, 'billNo', 'billDate', 'sourceType', 'sourceId', 'sourceNo', 'handlerId', 'isRubric', 'attachment', 'remark', 'billProcStatus', 'approverId', 'flowId', 'isApproved', 'effectiveTime', 'isVoided', 'isClosed', 'sysOrgCode', 'createBy', 'createTime', 'updateBy', 'updateTime'))
      },
