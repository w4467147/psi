    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        ...
        <a-row>
          ...
          <a-col :span="8" v-show="action==='detail' && model.receiptType === '101'">
            <a-form-item label="已抵扣预收" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
        <a-tab-pane tab="收款明细" :key="refKeys[0]" :forceRender="true">
          <j-editable-table
            :disabled="readOnly"
            :ref="refKeys[0]"
            :loading="finReceiptEntryTable.loading"
            :columns="finReceiptEntryTable.columns"
            :dataSource="finReceiptEntryTable.dataSource"
            :maxHeight="300"
            :rowNumber="false"
            :rowSelection="true"
